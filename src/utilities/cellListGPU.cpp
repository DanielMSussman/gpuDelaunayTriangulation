 ...
 */
cellListGPU::cellListGPU(double a, std::vector<double> &points,periodicBoundaries &bx)
    {
    Nmax = 0;
    setParticles(points);
...
\param points the positions of points to populate the cell list with
 */
cellListGPU::cellListGPU(std::vector<double> &points)
    {
    Nmax = 0;
    Box = make_shared<periodicBoundaries>();
    setParticles(points);
 ...
 */
void cellListGPU::setParticles(const std::vector<double> &points)
    {
 ...
 */
void cellListGPU::setParticles(const std::vector<double2> &points)
    {
